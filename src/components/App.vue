<template>
  <span>
    <h1 class="title">Statuslight Online</h1>
    ...
    <div class="content">
      ...
      <wifi-step @deviceInformation="receiveDeviceInformation" @wifiConfig="receiveWifiConfig" @done="goToNextStep" @loading="setLoading" @loaded="stopLoading" v-if="currentStep === 2" />
      <mqtt-step :device-information="deviceInformation" @mqttConfig="receiveMqttConfig" @done="goToNextStep" v-if="currentStep === 3" />
      <sending-step :configuration="config" @loading="setLoading" @loaded="stopLoading" v-if="currentStep === 4" />
